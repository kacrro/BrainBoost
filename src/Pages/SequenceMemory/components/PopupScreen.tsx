...
const PopupScreen = ({score, setScore, popupVisible, setIsStarted, setPopupVisible, replay, setReplay}: {
  ...
  const [localScoreId, setLocalScoreId] = useState<number>(0); // Add this line
  ...
  useEffect(() => {
    ...
    if (replay && popupVisible) {
      fetchRecentScores();
    }
  }, [replay, popupVisible, userEmail, score]);
